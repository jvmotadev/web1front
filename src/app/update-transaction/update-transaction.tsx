import { useEditTransactionForm } from "./update-config";
import { TransactionData } from "./put-config";
...
export function EditTransactionModal({ transaction }: { transaction: TransactionData }) {
  const { formData, handleInputChange, handleSelectChange, handleSubmit } = useEditTransactionForm(transaction);
      ...
      <TabsContent value="saida">
        <Card>
          <CardHeader>
            ...
            <CardDescription>Atualize seu registro.</CardDescription>
          </CardHeader>
